    ...
    <nav class="navbar bg-light navbar-light">
        <a href="https://www.kominfo.go.id/" class="navbar-brand mx-4 mb-3">
            <h6 class="text-primary"><img src="{{ asset('dashmin') }}/assets/img/kominfo.png" alt="logo_kominfo.png"
                    style="width: 40px; height: 40px;"> ISR - BROADCASTING</h6>
        </a>
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="/menu/data-broadcastings"
                class="nav-item nav-link {{ Request::is('menu/data-broadcastings*') ? 'active' : '' }}"><i
                    class="fa fa-tower-broadcast me-2"></i>Data Broadcasting</a>
